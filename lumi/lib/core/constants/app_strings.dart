class AppStrings {
  static const String welcomeHeader = "Welcome to Lumi";
  static const String description =
      "Your personal AI-powered diary for self-reflection and growth.";
  static const String googleAuthButton = "Continue with Google";
  static const String emailAuthButton = "Continue with Email";
  ...
  static const String codeEnterHeader = "Email has been sent.";
  static const String codeEnterDescription =
      "We've sent a verification code and a login link to your email.";
}
